...
(function (blink) {
	...
	var Anaya_Prim_Incial_2022_DevStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	Anaya_Prim_Incial_2022_DevStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_Anaya_Prim_Incial_2022_Dev',
		ckEditorStyles: {
			name: 'Anaya_Prim_Incial_2022_Dev',
			styles: [
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'Anaya_Prim_Incial_2022_Dev-navbar'),
	...
	Anaya_Prim_Incial_2022_DevStyle.prototype = _.extend({}, new blink.theme.styles.basic(), Anaya_Prim_Incial_2022_DevStyle.prototype);

	blink.theme.styles['Anaya_Prim_Incial_2022_Dev'] = Anaya_Prim_Incial_2022_DevStyle;
